      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 w-full lg:w-3/4 p-10 md:p-14 flex flex-col justify-center">
            ...
            >
              ACHIEVEMENTS THAT <span className="text-[#E31E24]">INSPIRE</span>
            </motion.h2>
            ...
            >
              ...
              {/* Stat 3 */}
              <motion.div variants={statVariants} className="flex-1 border-l border-white/20 pl-0 md:pl-4 flex flex-col items-center text-center">
                <svg className="w-12 h-12 text-[#E31E24] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
