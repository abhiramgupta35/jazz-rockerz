  ...
  return (
    <section className="bg-[#260e44] text-white relative overflow-hidden mt-10" id="admissions">
      ...
      <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
        ...
        <svg className="absolute bottom-4 left-10 w-48 h-48 text-[#E91E73]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full min-h-[550px] flex flex-col lg:flex-row items-center justify-between pt-16 pb-0 lg:py-0">
        ...
        <motion.div 
          ...
          className="w-full lg:w-[50%] flex flex-col justify-center py-10 lg:py-24 z-30"
        >
          <h2 className="text-[2.75rem] md:text-5xl lg:text-[4rem] font-black uppercase tracking-tight leading-[1.05] mb-2">
            ADMISSIONS <span className="text-[#E91E73]">OPEN!</span>
          </h2>
          <p className="text-[#fbbd08] text-xl lg:text-[1.35rem] font-bold mb-10 tracking-wide">
            Book Your FREE Trial Class Today!
          </p>

          <div className="flex flex-wrap md:flex-nowrap justify-between items-start w-full max-w-[500px]">
            {/* Icon 1 */}
            <div className="flex flex-col items-center text-center px-1">
              <svg className="w-10 h-10 text-[#E91E73] mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
              <span className="text-[15px] font-bold leading-[1.3]">Free Trial<br/>Class</span>
            </div>
            ...
            {/* Icon 2 */}
            <div className="flex flex-col items-center text-center px-1">
              <svg className="w-10 h-10 text-[#E91E73] mb-3 relative" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <circle cx="15" cy="15" r="4" fill="#260e44" stroke="#E91E73" strokeWidth="2" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 13v2l1.5 1.5" />
              </svg>
              <span className="text-[15px] font-bold leading-[1.3]">Limited<br/>Seats</span>
            </div>
            ...
            {/* Icon 3 */}
            <div className="flex flex-col items-center text-center px-1">
              <svg className="w-10 h-10 text-[#E91E73] mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M14 3v5h5" />
              </svg>
              <span className="text-[15px] font-bold leading-[1.3]">Easy<br/>Registration</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center px-1">
              ...
              <span className="text-[15px] font-bold leading-[1.3]">All Ages<br/>Welcome</span>
            </div>
          </div>

          <div className="mt-12">
            <span className="text-[#E91E73] font-serif italic font-bold text-3xl transform -rotate-3 inline-block">
              Small Steps<br/>
              <span className="pl-6">Big Futures</span>
            </span>
            <div className="h-0.5 w-40 bg-[#E91E73] transform -rotate-3 mt-1 rounded-full"></div>
          </div>
        </motion.div>
        ...
        {/* Mobile only image */}
        <div className="block lg:hidden w-full h-[350px] relative mt-10 mb-5 z-20 pointer-events-none">
          <Image
            src="/images/Admission-Open.webp"
            alt="Student Pointing"
            fill
