  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative min-h-[480px] flex items-center bg-gradient-to-br from-[#120024] via-[#1C0035] to-[#2B0050] text-white py-16 overflow-hidden">
        ...
        <div className="absolute -top-20 -right-20 w-96 h-96 bg-brand-pink/20 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="mt-10 bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-card grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-pink-50 text-brand-pink flex items-center justify-center shrink-0 mt-1">
            ...
            <div className="lg:col-span-6 h-64 sm:h-72 rounded-2xl bg-gradient-to-br from-pink-50 via-purple-50 to-white border border-dashed border-pink-200 flex flex-col items-center justify-center p-6 text-center">
              <div className="w-12 h-12 rounded-full bg-brand-pink/10 text-brand-pink flex items-center justify-center mb-3">
                <MapPin className="w-6 h-6 text-brand-pink animate-bounce" />
              </div>
              <h4 className="text-base font-extrabold text-brand-purple">
                {branch.name} Studio
              </h4>
              ...
              <a
                ...
                className="mt-4 inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-brand-pink text-white text-xs font-bold hover:bg-brand-pink-hover transition-colors shadow-sm"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-4">
              <h2 className="text-3xl sm:text-5xl font-black uppercase text-white">
                ...
                <span className="text-brand-pink">{branch.name}</span>
              </h2>
